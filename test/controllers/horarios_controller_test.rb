...
class HorariosControllerTest < ActionController::TestCase
  ...
  test "should create horario" do
    assert_difference('Horario.count') do
      post :create, horario: { fecha: @horario.fecha, hora_fin: @horario.hora_fin, hora_inicio: @horario.hora_inicio, tipo_tramite: @horario.tipo_tramite }
    end
  ...
  test "should update horario" do
    patch :update, id: @horario, horario: { fecha: @horario.fecha, hora_fin: @horario.hora_fin, hora_inicio: @horario.hora_inicio, tipo_tramite: @horario.tipo_tramite }
    assert_redirected_to horario_path(assigns(:horario))
  end
