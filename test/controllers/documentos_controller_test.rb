...
class DocumentosControllerTest < ActionController::TestCase
  ...
  test "should create documento" do
    assert_difference('Documento.count') do
      post :create, documento: { estudiante_id: @documento.estudiante_id, fecha_ingreso: @documento.fecha_ingreso, observacion: @documento.observacion, tipo_documento: @documento.tipo_documento }
    end
  ...
  test "should update documento" do
    patch :update, id: @documento, documento: { estudiante_id: @documento.estudiante_id, fecha_ingreso: @documento.fecha_ingreso, observacion: @documento.observacion, tipo_documento: @documento.tipo_documento }
    assert_redirected_to documento_path(assigns(:documento))
  end
